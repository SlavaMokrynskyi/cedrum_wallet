...
export default function page() {
  return (
    <main>
        ...
        <div>
          <p className={styles.text}> Backup and sync lets us store encrypted data for your custom settings and features.
          ...
          This doesn't back up your Secret Recovery Phrase.</p>
        </div>
